...
//! DATE: 2022-03-30, STEPS: `20`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {	fn set_bit_power_exchange_rate() -> Weight {
		(8_000_000 as Weight)			.saturating_add(T::DbWeight::get().writes(1 as Weight))	}	fn set_power_balance() -> Weight {
		(9_000_000 as Weight)			.saturating_add(T::DbWeight::get().writes(1 as Weight))	}	fn stake() -> Weight {
		(27_000_000 as Weight)			.saturating_add(T::DbWeight::get().reads(5 as Weight))			.saturating_add(T::DbWeight::get().writes(3 as Weight))	}	fn unstake() -> Weight {
...
impl WeightInfo for () {	fn set_bit_power_exchange_rate() -> Weight {
		(8_000_000 as Weight)			.saturating_add(RocksDbWeight::get().writes(1 as Weight))	}	fn set_power_balance() -> Weight {
		(9_000_000 as Weight)			.saturating_add(RocksDbWeight::get().writes(1 as Weight))	}	fn stake() -> Weight {
		(27_000_000 as Weight)			.saturating_add(RocksDbWeight::get().reads(5 as Weight))			.saturating_add(RocksDbWeight::get().writes(3 as Weight))	}	fn unstake() -> Weight {
