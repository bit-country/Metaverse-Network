...
pub mod pallet {
    ...
    pub(super) type ClassDataType<T: Config> =
        StorageMap<_, Blake2_128Concat, ClassIdOf<T>, TokenType, ValueQuery>;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create_class(
            ...
            <T as Config>::Currency::reserve(
                &class_fund,
                <T as Config>::Currency::free_balance(&class_fund),
            )?;
        ...
        pub fn mint(
            ...
            let class_info =
                NftModule::<T>::classes(class_id).ok_or(Error::<T>::ClassIdNotFound)?;
        ...
        pub fn transfer_batch(
            ...
            for (_i, x) in tos.iter().enumerate() {
                ...
                let class_info =
                    NftModule::<T>::classes(asset.0).ok_or(Error::<T>::ClassIdNotFound)?;
