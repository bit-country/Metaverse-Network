...
fn create_new_auction_work() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_ok!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, ALICE, 100, 0, ListingLevel::Global));
...
fn create_auction_fail() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_noop!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, BOB, 100, 0, ListingLevel::Global
        ...
        assert_noop!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(1), None, ALICE, 100, 0, ListingLevel::Global), Error::<Runtime>::NoPermissionToCreateAuction);

        //Asset is already in an auction
        assert_ok!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, ALICE, 100, 0, ListingLevel::Global));
        assert_noop!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, ALICE, 100, 0, ListingLevel::Global), Error::<Runtime>::AssetAlreadyInAuction);
    });
}
...
fn bid_works() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_ok!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, BOB, 100, 0, ListingLevel::Global));
...
fn cannot_bid_with_insufficient_funds() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        init_test_nft(owner.clone());
        assert_ok!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, BOB, 600, 0, ListingLevel::Global));
...
fn cannot_bid_on_ended_auction() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        init_test_nft(owner.clone());
        assert_ok!(NftAuctionModule::create_auction(AuctionType::Auction, ItemId::NFT(0), None, BOB, 150, 0, ListingLevel::Global));
...
fn buy_now_work() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_ok!(NftAuctionModule::create_auction(AuctionType::BuyNow, ItemId::NFT(1), None, BOB, 150, 0, ListingLevel::Global));
...
fn buy_now_should_fail() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        System::set_block_number(1);
        assert_ok!(NftAuctionModule::buy_now(buyer.clone(), 0, 150));
        assert_noop!(NftAuctionModule::create_auction(AuctionType::BuyNow, ItemId::NFT(0), None, BOB, 150, 0, ListingLevel::Global),Error::<Runtime>::NoPermissionToCreateAuction);
    });
}
