use crate::{
	...
	service::{pioneer_partial as new_partial, ParachainRuntimeExecutor},
};
use codec::Encode;
use cumulus_client_service::genesis::generate_genesis_block;
use cumulus_primitives_core::ParaId;
use log::info;
use pioneer_runtime::{opaque::Block, RuntimeApi};
...
fn load_spec(id: &str, para_id: ParaId) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
	Ok(match id {
		...
		"pioneer" => Box::new(chain_spec::pioneer::live_pioneer_config()?),
		"pioneer-live" => Box::new(chain_spec::pioneer::live_pioneer_config()?),
...
impl SubstrateCli for Cli {
	fn impl_name() -> String {
		"Pioneer Network Collator Node".into()
	}
	...
	fn support_url() -> String {
		"https://github.com/bit-country/Metaverse-Network/issues/new".into()
	}
