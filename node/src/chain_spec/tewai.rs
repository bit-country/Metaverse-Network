...
pub use tewai_runtime::GenesisConfig;
...
fn staging_testnet_config_genesis() -> GenesisConfig {
	...
	// done and
	// for i in 1 2 3 4 ; do for j in session; do subkey --ed25519 inspect "$secret"//fir//$j//$i; done;
	// done
...
pub fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(tewai_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
